...
<div class="container">
	...
	<div>
		...
		<table class="table">
			<thead>
				<tr class="danger">
					<th class="text-center">평균자책</th>
					<th class="text-center">피안타</th>
					<th class="text-center">경기수</th>
					<th class="text-center">탈삼진</th>
					<th class="text-center">사사구</th>
					<th class="text-center">자책점</th>
					<th class="text-center">피홈런</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${pitcher2}" var="dto">
					<tr>
						<th class="text-center">${dto.era}</th>
						...
						<th class="text-center">${dto.jachak}</th>
		...
		<table class="table">
			<thead>
				<tr class="danger">
					...
					<th class="text-center">이닝수</th>
					<th class="text-center">실점</th>
					<th class="text-center">자책</th>
					<th class="text-center">타자수</th>
					<th class="text-center">타수수</th>
					<th class="text-center">총피안타</th>
					<th class="text-center">피2루타</th>
					<th class="text-center">피3루타</th>
					<th class="text-center">피홈런</th>
					<th class="text-center">볼넷</th>
					<th class="text-center">고의사구</th>
			...
			<tbody>
				<c:forEach items="${pitcher}" var="dto">
					<tr>
						...
						<th class="text-center">${dto.ining}</th>
						<th class="text-center">${dto.siljum}</th>
						<th class="text-center">${dto.jachak}</th>
						<th class="text-center">${dto.taja}</th>
						...
						<th class="text-center">${dto.sagu}</th>
						<th class="text-center">${dto.samjin}</th>
						<th class="text-center">${dto.tugu}</th>
					</tr>
				</c:forEach>
