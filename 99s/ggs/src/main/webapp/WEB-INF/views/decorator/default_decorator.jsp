...
<body>
	<header>
		<nav class="navbar navbar-inverse">
			<div class="navbar-header">
				...
				<img src="/resources/img/아이콘.PNG" height="50px" style="padding-top: 0"></a>
			</div>
	...
	<footer class="container-fluid text-center navbar navbar-inverse navbar-fixed-bottom">
		<p>본 사이트는 <b>팀 '구로구기러기'</b>에 의해 비영리 목적으로 제작되었습니다. (운영기간 : 2020.07.02 ~ 2021.07.01)<br/>
		 개발 구성원 : 이준(팀장), 강동혁, 김아리, 박종수, 황민동, (최현우)</p>
	</footer>
</body>
</html>