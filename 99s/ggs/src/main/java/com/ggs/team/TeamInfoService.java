...
public class TeamInfoService {
	...
	public TeamInfoDTO teamDetail(String name) {
		...
		if(!teamDetail.getTeamName().equals("없음")) {
			...
			teamDetail.setAvgLoss(teamRecord.getAvgLoss());
			teamDetail.setAvgScore(teamRecord.getAvgScore());
			teamDetail.setRate(teamRecord.getRate());
			teamDetail.setMaxLoss(teamRecord.getMaxLoss());
			teamDetail.setMaxScore(teamRecord.getMaxScore());
			teamDetail.setZeroLoss(teamRecord.getZeroLoss());
			teamDetail.setZeroScore(teamRecord.getZeroScore());
		}
		return teamDetail;	
	}
