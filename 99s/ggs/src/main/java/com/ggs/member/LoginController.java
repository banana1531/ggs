...
public class LoginController {
	...
	public ModelAndView loginProc(MembersDTO mdto,HttpSession session,
		...
		if(result==null){
			...
			//로그인 성공
				int r = mService.loginChk(result);
				System.out.println("r="+r);
				RedirectView rv=new RedirectView("../mypage/mypageMain.gg?result="+r); //main으로 이동하기로 변경예정
				mv.setView(rv);
			}
		return mv;
	}
	...
	public String pwChgFrm(@RequestParam(value="id") String id,
