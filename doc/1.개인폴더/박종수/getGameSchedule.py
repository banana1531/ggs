...
#쿼리문 작성
#sql='insert into teamRecord (gdate, gtime, ateamname, ascore, bteamname, bscore, stadium) values(%s,%s,%s,%s,%s,%s,%s)'

#for i in range(1,11):
url="https://sports.news.naver.com/kbaseball/schedule/index.nhn?date=20200701&month="+str(7)+"&year=2020&teamCode="
